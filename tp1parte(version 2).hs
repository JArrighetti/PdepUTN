...
quienTieneMasDeN bloqueAAplicar lista numero = filter ((>numero).billetera.(flip aplicarBloqueDeTransaccionesAUnUsuario) bloqueAAplicar)  lista
...
quienesMasRico bloqueAAplicar lista = fromJust (find ((==billeteraMasRica bloqueAAplicar lista).billetera.(flip aplicarBloqueDeTransaccionesAUnUsuario) bloqueAAplicar) lista)
--punto 24 de bloques
...
quienEsMenosRico bloqueAAplicar lista = fromJust (find ((==billeteraMenosRica bloqueAAplicar lista).billetera.(flip aplicarBloqueDeTransaccionesAUnUsuario) bloqueAAplicar) lista)
